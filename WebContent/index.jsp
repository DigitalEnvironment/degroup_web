...
<html>
<head>
	<title>Digital Environment Group - Website</title>
...
<body class="pull_top">
    ...
    <section id="feature_slider" class="lol">
        ...
        <article class="slide" id="ideas" style="background: url('img/backgrounds/aqua.jpg') repeat-x top center;">
            <div class="info">
                <h2>Ideas innovadoras aplicando tecnolog&iacutea en tu negocio.</h2>
            </div>
        ...
        <article class="slide" id="tour" style="background: url('img/backgrounds/color-splash.jpg') repeat-x top center;">
            ...
            <div class="info">
                <h2>Integrado para todos los dispositivos.</h2>
                <a href="features.html" style="pointer-events: none">MUY PRONTO</a>
            </div>
        </article>
        <article class="slide" id="responsive" style="background: url('img/backgrounds/indigo.jpg') repeat-x top center;">
            ...
            <img class="asset left-220 sp500 t150 z2" src="img/slides/scene4/css3.png" />
            <img class="asset left-1 sp400 t120 z1" src="img/slides/scene4/java.png" />
            <div class="info">
                <h2>
                     Trabajamos con <strong> HTML5,CSS3 & JAVA</strong>
                </h2>                
            </div>
        </article>        
    </section>
            ...
            <div class="row feature_wrapper">
                ...
                <div class="features_op1_row">
                    ...
                    <div class="col-sm-4 feature first">
                        <div class="img_box">
                            <a href="services.html">
                                <img src="img/deg/diseno_web.jpg">
                                <span class="circle"> 
                        ...
                        <div class="text">
                            <h6>Dise&ntildeo Web</h6>
                            <p>
                                De acuerdo a la estrategia de tu empresa creamos un dise&ntildeo creativo y original.
                            </p>
                        </div>
                    </div>
                    <!-- Feature -->
                    <div class="col-sm-4 feature">
                        <div class="img_box">
                            <a href="services.html">
                                <img src="img/deg/desarrollo_web.jpg">
                                <span class="circle"> 
                                    <span class="plus">&#43;</span>
                                </span>
                            </a>
                        ...
                        <div class="text">
                            ...
                            <p>
                                Mediante programaci&oacuten creamos p&aacuteginas web administrables que permiten gestionar su contenido.
                            </p>
                        </div>
                    </div>
                    <!-- Feature -->
                    <div class="col-sm-4 feature last">
                        <div class="img_box">
                            <a href="services.html">
                                <img src="img/deg/aplicaciones_web.jpg" width="1000" height="180">
                                <span class="circle"> 
                                    <span class="plus">&#43;</span>
                                </span>
                            </a>
                        ...
                        <div class="text">
                            ...
                            <p>
                                Manejamos tecnolog&iacuteas de vanguardia para desarrollar aplicaciones web en l&iacutenea.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="row sections">
                ...
                <div class="col-sm-4 contact">
                    ...
                    <form action="#" method="post">
                        <input type="text" placeholder="Tu nombre" name="envNombre"/>
                        <input type="text" placeholder="Tu e-mail" name="envEmail"/>
                        <textarea rows="3" placeholder="Mensaje" name="envMensaje"></textarea>
