        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse" role="navigation">
                <ul class="nav navbar-nav navbar-right">
                    <li class="active"><a href="somos.jsp">QUIENES SOMOS</a></li>
                    <li class="dropdown">
            ...
            <div class="row people">
                <div class="row row1">
                    <div class="col-sm-6 bio_box">
                        <img src="img/renzo.png" alt="">
                        <div class="info">
                            <p class="name">Renzo Delgado Guerra</p>
                            <p class="area">CEO & DEVELOPER</p>
                            <a href="https://www.facebook.com/rnzodelgado" class="facebook" target="_blank">
                                <span class="socialicons ico1"></span>
                                <span class="socialicons_h ico1h"></span>
                            </a>
                            <a href="https://twitter.com/renzo425" class="twitter" target="_blank">
                    ...
                    <div class="col-sm-6 bio_box bio_boxr">
                        <img src="img/felix.png" alt="">
                        <div class="info">
                            <p class="name">Felix Apaza Arroyo</p>
                            <p class="area">CEO & DEVELOPER</p>
                            <a href="https://www.facebook.com/lysander21" class="facebook" target="_blank">
                                <span class="socialicons ico1"></span>
                                <span class="socialicons_h ico1h"></span>
                            </a>
            ...
            <div class="row services_circles">
                <div class="col-sm-4 description">
                    <div class="text active">
                        <h4>Planificar lo que necesitas.</h4>
                        <p>
                    ...
                    <div class="text">
                        <h4>Desarrollar tu producto o servicio.</h4>
                        <p>
                    ...
                    <div class="text">
                        <h4>Dise&ntildear temas segun tus necesidades.</h4>
                        <p>
                            There are many variations of passages of  this suffered alteration in some form, by injected look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to making this the first true generator  Internet.</p>
                    </div>
                </div>
